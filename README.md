...
Train a tiny LoRA for efficient custom safety profiles, in this case Youth safety. Udes Qwen 3 as a base. Process: Generate/prepare a synthetic dataset, train a LoRA checkpoint with SFT, optionally run a second-stage GRPO-style refinement, then run quick evals to see how behavior changed.
